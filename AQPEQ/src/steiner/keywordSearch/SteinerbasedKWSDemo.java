...
public class SteinerbasedKWSDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SteinerbasedKWSDemo stinerbasedKWS = new SteinerbasedKWSDemo();
    ...
    private void print(ResultTree resultTree) {
        ...
        for (RelationshipInfra e : resultTree.anOutputTree.edgeSet()) {
            ...
            System.out.println(
                    "relationship: " + DummyFunctions.getRelationshipOfPairNodes(graph, sourceID, targetID));
        }
    }
...
//	}
    ...
    public void findCandidatesOfKeywordsUsingInvertedList(HashSet<String> keywords) throws Exception {
        ...
        for (String keyword : keywords) {
            ...
            for (String token : DummyFunctions.getTokens(keyword)) {
    ...
    public void preKWS(HashSet<String> keywords, int exp) throws Exception {
    ...
    public HashMap<Integer, CostAndNodesOfAnswersPair> keywordExpand(ArrayList<AnswerAsInput> topNAnswers,
                                                                     LinkedHashSet<String> keywords, double cost, int exploreRange) throws Exception {
        ...
        steinerKWSExpand = new SteinerKWSExpansion(graph, topNAnswers, cost, exploreRange, keywordsSet);
