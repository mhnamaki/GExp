...
public class DataCloudDistinguishability {
	...
	public ArrayList<String> expandFromScratch() throws Exception {
		...
		for (String ssss : topFrequentKeywords) {
	...
	public static void main(String[] args) throws Exception {
		...
		nodeIdsOfToken = gir.indexInvertedListOfTokens(gir);

		HashSet<String> keywords = new HashSet<String>();
		//keywords.add("arzak");
		//keywords.add("etxebarri");
		keywords.add("restaurant");

		DataCloudDistinguishability d = new DataCloudDistinguishability(gir, gir.nodeIdsOfToken, null, 1000, keywords);
