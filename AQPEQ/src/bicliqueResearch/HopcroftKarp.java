...
//import quickTests.Graph;
//
//public class HopcroftKarp {
//	private static final int UNMATCHED = -1;
//
//	private final int V; // number of vertices in the graph
//	private BipartiteGraph bipartition; // the bipartition
...
//	 */
//	public HopcroftKarp(BipartiteGraph bipartition) {
//
//		// initialize empty matching
//		this.V = bipartition.getNodeCount();
//		mate = new int[V];
//		for (int v = 0; v < V; v++)
//			mate[v] = UNMATCHED;
//
...
//			Iterator<Integer>[] adj = (Iterator<Integer>[]) new Iterator[bipartition.getNodeCount()];
//			for (int v = 0; v < bipartition.getNodeCount(); v++)
//				adj[v] = bipartition.getNextNodes(v).iterator();
//
//			// for each unmatched vertex s on one side of bipartition
//			for (int s = 0; s < V; s++) {
//				if (isMatched(s) || !bipartition.getNodeById(s).bipartiteSide)
