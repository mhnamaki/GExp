...
public class DistinctRootExperiment2 {

	GraphInfraReaderArray graph;

	// xin
	 private static String graphInfraPath =
	 "/Users/zhangxin/AQPEQ/GraphExamples/TestBiGra/";
	 private static String keywordsPath =
	 "/Users/zhangxin/AQPEQ/GraphExamples/TestBiGra/AB.in";
...
//	private static String keywordsPath = "/Users/mnamaki/Documents/Education/PhD/Summer2017/AQEQ/Datasets/dbp/dbpGraphInfra/keywords/knuthPrize.txt";
//	private static String envFilePath = "/Users/mnamaki/Documents/Education/PhD/Summer2017/AQEQ/Datasets/imdb/bdb/withProp/dbEnvWithProp";
	...
	public DistinctRootExperiment2() {
	...
	public static void main(String[] args) throws Exception {
		...
		DistinctRootExperiment2 experimentUsingBDB = new DistinctRootExperiment2();
							...
							while (exp < numberOfSameExperiments) {
								...
								if (keywordSuggestionOn) {
									...
									if (qualityExp) {
										...
										generateBipartiteGraph(topNAnswers, keywords);
									...
									if (incEvalOn) {
										...
										System.out.println("selected keyword nodeIds were: "
												+ Arrays.toString(rootKWSExpand.bestKeywordInfo.nodeId));
										System.out.println("lowest weight suggested keywrd: " + StringPoolUtility
	...
	public void generateBipartiteGraph(ArrayList<AnswerAsInput> topNAnswers,
			ArrayList<String> keywords) throws Exception {
		System.out.println("-------------------------");
		System.out.println("Start generating Bipartite Graph");
		HashSet<Integer> keywordsSet = new HashSet<Integer>();
		...
		for (int topAnswer : answerKeywordMap.keySet()){
			...
			for (int keyword : keywordDistance.keySet()){
				if (visitedNode.containsKey(keyword)){
					...
					float weight = (float) keywordDistance.get(keyword).doubleValue();
					NodeInfra node = bipartiteGraph.getAndAddANewBipartiteNodeInfra(keyword, weight, BipartiteSide.USide);
		...
		System.out.println("Test for Bipartite Graph");
		System.out.println("G has " + bipartiteGraph.getNodeCount() + " nodes.");
		System.out.println("G has " + bipartiteGraph.getEdgeCount() + " edges.");
		System.out.println("U side has " + bipartiteGraph.getNodesOfSide(BipartiteSide.USide).size() + " nodes.");
		System.out.println("V side has " + bipartiteGraph.getNodesOfSide(BipartiteSide.VSide).size() + " nodes.");
		ArrayList<NodeInfra> allNode = bipartiteGraph.getAllNodes();
		System.out.println("U side.");
		for (int nodeId : bipartiteGraph.getNodesOfSide(BipartiteSide.USide)) {
			for (int id : allNode.get(nodeId).tokens){
				System.out.println("node " + StringPoolUtility.getStringOfId(id));
			}
		}
		System.out.println("-------------------------");
	}
