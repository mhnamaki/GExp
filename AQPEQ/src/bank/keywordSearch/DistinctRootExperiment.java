...
public class DistinctRootExperiment {

    GraphInfraReaderArray graph;

    // xin
    private static String graphInfraPath = "/Users/zhangxin/AQPEQ/GraphExamples/k1Infra/graph/";
    ...
    public static void main(String[] args) throws Exception {
        ...
        DistinctRootExperiment experimentUsingBDB = new DistinctRootExperiment();
