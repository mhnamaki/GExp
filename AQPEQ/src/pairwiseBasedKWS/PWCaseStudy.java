...
//	private static String keywordsPath = "/Users/mnamaki/Documents/Education/PhD/Summer2017/AQEQ/Datasets/imdb/queries/temp/imdb_temp.txt";
...
//	private static int[] distanceBounds = { 2 };
...
//
//		PWCaseStudy kws = new PWCaseStudy();
//		kws.runMain(args);
//
//	}
//
...
//
//									// Suggest keywords based on Diversification
//									// function
//
//									Diversification div = new Diversification(graph);
//									HashSet<String> diversifiedKeywords = div.run(estimatedWeightOfSuggestedKeywordMap,
//											topNAnswers, false, graph, 2, nodeIdsOfToken);
